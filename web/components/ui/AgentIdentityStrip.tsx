 ...
 *  fallback for unassigned tasks) and the run duration — how long the agent ran (frozen once
 *  the task finishes), shown with a timer icon so it reads as a duration, not a clock time. */
